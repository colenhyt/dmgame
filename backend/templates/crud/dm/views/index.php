...
?>         
            ...
            foreach ($models as $model) {
                echo '<tr id="rowid_' . $model-><?=$idName?> . '">';
                echo '  <td><label><input type="checkbox" value="' . $model-><?=$idName?> . '"></label></td>';
<?php 
foreach($tableColumnInfo as $key=>$column){
    if($column['isDisplay'] === true){
...
?>
                ...
                echo '      <a id="view_btn" onclick="viewAction(' . $model-><?=$idName?> . ')" class="btn btn-primary btn-sm" href="#"> <i class="glyphicon glyphicon-zoom-in icon-white"></i>查看</a>';
                echo '      <a id="edit_btn" onclick="editAction(' . $model-><?=$idName?> . ')" class="btn btn-primary btn-sm" href="#"> <i class="glyphicon glyphicon-edit icon-white"></i>修改</a>';
                echo '      <a id="delete_btn" onclick="deleteAction(' . $model-><?=$idName?> . ')" class="btn btn-danger btn-sm" href="#"> <i class="glyphicon glyphicon-trash icon-white"></i>删除</a>';
                echo '  </td>';
                echo '</tr>';
            }
